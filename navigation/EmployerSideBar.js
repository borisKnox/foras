            ...
            <Container>
                ...
                <ScrollView style={{flex: 1}}>
                    ...
                    <View style={{ alignItems: 'center',}}>
                        ...
                        <TouchableOpacity style={styles.companyBrandPart} onPress={()=> this.props.navigation.replace('MyProfile') }>
                        ...
                        <View style={{width: '100%',}}>
                            <TouchableOpacity style={styles.menuItem} onPress={()=>this.props.navigation.replace('Main') }>
                        ...
                        <View style={{width: '100%'}}>
                            <TouchableOpacity style={styles.menuItem} onPress={()=>this.props.navigation.replace('Notification') }>
                        ...
                        <View style={{width: '100%'}}>
                            <TouchableOpacity style={styles.menuItem} onPress={()=>this.props.navigation.replace('Message') }>
                        ...
                        <View style={{width: '100%'}}>
                            <TouchableOpacity style={styles.menuItem} onPress={()=>this.props.navigation.replace('FavoritUserList') }>
                        ...
                        <View style={{width: '100%'}}>
                            <TouchableOpacity style={styles.menuItem} onPress={()=> this.props.navigation.replace('JobList')}>
                        ...
                        <View style={{width: '100%'}}>
                            <TouchableOpacity style={styles.menuItem} onPress={()=>this.props.navigation.replace('UserList') }>
                                <Image source={require('../assets/images/sidemenu/icon-menu-user.png')}  style={{width: 19, height: 21, resizeMode:"contain" }}/>
                                <Text  style={ {fontSize: 14, fontFamily: 'TheSans-Plain', marginLeft: 16, color: Colors.secondaryText}}>{Labels._sidemenu_individual}</Text>
                            </TouchableOpacity>
                        </View>

                         <View style={{width: '100%'}}>
                            <TouchableOpacity style={styles.menuItem} onPress={()=> this.props.navigation.replace('MyProfile') }>
