...
export default class MainScreen extends React.Component {
    ...
    toggleWorkdaysModal = () => {
        ...
        this.setState({spinner: true});
        api.getJobList_filter_workdays(global.token, filterCategory).then((res)=>{
            console.log('getJobList response____');  
            if(res.status == 200){
                this.setState({spinner: false});
                this.setState({jobList: res.data});
                console.log("this.state.individualsList", this.state.jobList);
    ...
    toggleFulltimeModal = () => {
        ...
        api.getJobList_filter_workhour(global.token, this.state.workhour).then((res)=>{
            console.log('getJobList response____');  
            if(res.status == 200){
                this.setState({spinner: false});
                this.setState({jobList: res.data});
    ...
    toggleSalaryModal = () => {
        ...
        api.getJobList_filter_compensation(global.token, this.state.salary_type, this.state.salary_amount1).then((res)=>{
            console.log('getJobList response____');  
            if(res.status == 200){
                this.setState({spinner: false});
                this.setState({jobList: res.data});
    ...
    toggleParttimeModal = () => {
        ...
        api.getJobList_filter_Period (global.token, this.state.period, this.state.salary_amount2).then((res)=>{
            console.log('getJobList response____');  
            if(res.status == 200){
                this.setState({spinner: false});
                this.setState({jobList: res.data});
                    ...
                    <KeyboardAvoidingView style={styles.container}>                
                        ...
                        <View style={styles.mapMaskView}>
                            <MapView 
                                ...
                                <MapView.Marker
                                    // onPress={() => this.refModalShare.open(data)}
                            ...
                            <View style={styles.modalContainer}>
                                <View style={styles.modalContent}>
                                    ...
                                    <View style={{ flex: 3, width: '80%', justifyContent: 'center', alignItems: 'center'}}>
                                        {/* <TouchableOpacity style={{flexDirection: 'row', height: 40, width: '100%', borderRadius: 20, borderWidth: 1, borderColor: Colors.secondaryText}} >
                                ...
                                <View style={styles.modalContent}>
                                    ...
                                    <View style={{ flex: 3, width: '100%', justifyContent: 'center', alignItems: 'center', flexDirection: 'row'}}>
                                        ...
                                        <View style={{height: 40, width: '35%', borderRadius: 20, borderWidth: 1, borderColor: Colors.secondaryText, marginLeft: 10}}>
                                            {/* <Text style={{paddingTop: 7, textAlign: 'center', color: Colors.secondaryText}}>{Labels._modal_salary_textinput} </Text> */}
                            ...
                            <View style={styles.modalContainer}>
                                <View style={styles.modalContent}>
                                    ...
                                    <View style={{ flex: 3, width: '100%', justifyContent: 'center', alignItems: 'center', flexDirection: 'row'}}>
                                        ...
                                        {/* <TouchableOpacity style={{height: 40, width: '35%', borderRadius: 20, borderWidth: 1, borderColor: Colors.secondaryText, marginLeft: 10}}>
