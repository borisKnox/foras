...
const jobData = [
    ...
    {
        id: 'bd7acbea-c1b1-46c2-aed5sdfd-3ad53abb28ba',
        companyName: 'MP Marketing',
        jobTitle: 'مندوب',
        period: ' شهر',
        price: '3000',
...
function Item({ item }) {
    return (
        // companyName={item.users.name} logo={item.users.logo} jobTitle={item.job_name} period={item.period} deadline={item.end_date} price={item.salary_amount}
    ...
    componentDidMount(){
        ...
        api.getJobDetail(global.token, global.jobDetailId).then((res)=>{
            ...
            if(res.status == 200){
                ...
                console.log("====jobDetailData===", this.state.jobDetailData.job.users.reviews_received);           
                        ...
                        <Modal 
                            ...
                            <View style={{width: '100%', alignItems: 'center'}}>
                                <View style={{width: Dimensions.get('window').width * 0.85 , height: 300, backgroundColor: 'white', alignItems: 'center', borderRadius: 10}}>
                                    ...
                                    <TextInput style={{marginTop: 15,  height: 120, width: '80%', borderColor: Colors.thirdBackground, borderWidth: 1, borderRadius: 20, textAlign: 'right', textAlignVertical: 'top', padding: 10} } multiline={true} numberOfLines={10} blurOnSubmit={true} />
                                    
                                    <TouchableOpacity style={{width: 70, height: 70, backgroundColor: Colors.primarySpeical, borderRadius: 35, bottom: -35, position: 'absolute', alignItems: 'center', justifyContent: 'center'}} onPress={()=>this.toggleModal()}>
                        ...
                        <Modal 
                            ...
                            <View style={{width: '100%', alignItems: 'center'}}>
                                <View style={{width: Dimensions.get('window').width * 0.85 , height: 300, backgroundColor: 'white', alignItems: 'center', borderRadius: 10}}>
                                    ...
                                    <TextInput style={{marginTop: 15,  height: 120, width: '80%', borderColor: Colors.thirdBackground, borderWidth: 1, borderRadius: 20, textAlign: 'right', textAlignVertical: 'top', padding: 10} } multiline={true} numberOfLines={10} blurOnSubmit={true} value={this.state.message} onChangeText={text => this.setState({message: text})} />
                        ...
                        <Modal 
                            ...
                            <View style={{width: '100%', alignItems: 'center'}}>
                                <View style={{width: Dimensions.get('window').width * 0.85 , height: 300, backgroundColor: 'white', alignItems: 'center', borderRadius: 10}}>
                                    ...
                                    <TextInput style={{marginTop: 15,  height: 120, width: '80%', borderColor: Colors.thirdBackground, borderWidth: 1, borderRadius: 20, textAlign: 'right', textAlignVertical: 'top', padding: 10} } multiline={true} numberOfLines={10} blurOnSubmit={true} value={this.state.offerJobMessage} onChangeText={text => this.setState({offerJobMessage: text})} />
                        ...
                        {this.state.loading? 
                            <ScrollView  contentContainerStyle={styles.contentContainer}>
                                ...
                                <View style={styles.profileContainer}>
                                    ...
                                    <Text style={{padding: 20, textAlign: 'center', lineHeight: 16, fontFamily: 'TheSans-Plain'}}>شركة MP Marketing  هي شركة مساهمة سعودية ذات  مجال التسويق. أنشئت عام 1992 ميلادي. وتعمل فيمجالات عديدة من ظمنها التسويقء الدعاية والإعلان, التسويقالإلكتروني والمبيعات</Text>
                                    ...
                                    <View style={{width: '60%', flexDirection: 'row', marginBottom: 20}}>
                                            ...
                                            <View style={styles.logoContainer}>
                                                <Image source={{uri: this.state.jobDetailData.job.users.logo}}  style={{ height: 50, width: 50,}} />
                                            </View>
